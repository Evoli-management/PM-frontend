            ...
            <Section title="Professional Information" icon="💼">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-x-4 gap-y-2">
                        <div className="space-y-1">
                            ...
                            <input
                                ...
                                className={`w-full px-2 py-1.5 text-sm border-b border-gray-200 ${isEditingProfessional ? 'bg-white focus:border-gray-400' : 'bg-gray-50 cursor-default'} focus:outline-none`}
                ...
                <div className="flex justify-end items-center gap-2 mt-3">
                    {isEditingProfessional ? (
                        <>
                            <LoadingButton variant="outline" onClick={cancelProfessionalEdit} disabled={isLoading}>Cancel</LoadingButton>
                            <LoadingButton onClick={saveProfessionalInfo} isLoading={isLoading} loadingText="Saving...">Save</LoadingButton>
                        </>
                    ) : (
                        <LoadingButton variant="outline" onClick={() => setIsEditingProfessional(true)}>Edit</LoadingButton>
                    )}
                </div>
            </Section>
        </div>
