        ...
        export default function Sidebar({
            ...
            React.useEffect(() => {
                const handler = (e) => {
                    ...
                    if (openFirstKARef.current && Array.isArray(ka) && ka.length > 0) {
                        // select first KA after list arrives (alphabetical A→Z, Ideas last)
            ...
            const displayKeyAreas = React.useMemo(() => {
                ...
                // Deduplicate strict by id first
                const seen = new Set();
                arr = arr.filter((x) => {
                ...
                // If multiple Ideas present by name, keep system one (is_default) or first
