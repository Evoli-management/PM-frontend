...
export default function Registration() {
    ...
    const onSubmit = (e) => {
        e.preventDefault();
        if (!validate()) return;
        // Pending backend integration (API linkage & auth) – per your report.
        alert("Registered successfully (front-end demo).");
    };
                ...
                <div className="mt-8 grid gap-10 md:grid-cols-2">
                    ...
                    >
                        ...
                        <div className="space-y-3 pt-2">
                            <button
                                type="submit"
                                className="h-12 w-full rounded-lg bg-green-500 font-semibold text-white transition hover:bg-green-600"
                            >
                                Register
                            </button>
                            <button
                        ...
                        {/* Third‑party sign‑up (Google / Microsoft) */}
                        <div className="mt-4 grid gap-3 sm:grid-cols-2">
                            ...
                            >
                                <img src="/PM-frontend/google.svg" alt="Google" className="w-5 h-5" /> Continue with
                                Google
                            </button>
                            <button
                                type="button"
                                className="flex h-11 items-center justify-center gap-2 rounded-lg border border-gray-200 bg-white font-medium hover:bg-gray-50"
                            >
                                <img src="/PM-frontend/microsoft.svg" alt="Microsoft" className="w-5 h-5" /> Continue
                                with Microsoft
                            </button>
                        </div>
