        ...
        <main className="font-sans bg-gray-50 text-gray-900 min-h-screen">
            ...
            <nav className="flex flex-col sm:flex-row justify-between items-center px-4 py-4 bg-white shadow sticky top-0 z-10">
                ...
                <div className="flex flex-col sm:flex-row gap-2 sm:gap-8 text-base mb-2 sm:mb-0">
                    <a href="#modules" className="text-blue-900 hover:text-blue-700 font-medium">
                        Modules
                    </a>
                    <a href="#values" className="text-blue-900 hover:text-blue-700 font-medium">
                        Values
                    </a>
                    <a href="#testimonials" className="text-blue-900 hover:text-blue-700 font-medium">
                        Testimonials
                    </a>
                    <a href="#contact" className="text-blue-900 hover:text-blue-700 font-medium">
                        Contact
                    </a>
                </div>
            ...
            <section className="flex flex-col items-center justify-center px-2 py-10 bg-white">
                <div className="bg-white rounded-2xl shadow-lg p-6 w-full max-w-md mx-auto flex flex-col items-center">
                    <img
                        ...
                        className="mb-4 w-24 h-24 rounded-full shadow-lg object-contain"
                    />
                    ...
                    <p className="text-base sm:text-lg mb-6 text-gray-700 text-center">
                        A unique platform to transform the way you work. Built for teams of all sizes, focused on
                        productivity, engagement, and leadership.
                    </p>
                    <Link
                        to="/registration"
                        className="w-full rounded-lg bg-blue-700 text-white font-bold py-3 text-lg transition hover:bg-blue-800 mb-2 text-center"
                    >
                        Get Started Free
                    </Link>
                </div>
            ...
            <section id="modules" className="bg-gray-50 py-10">
                ...
                <div className="flex flex-wrap justify-center gap-6">
                    {modules.map((m, i) => (
                        <div
                            key={i}
                            className="bg-white rounded-2xl shadow-lg p-6 max-w-xs w-full text-center transition hover:scale-105"
                        >
            ...
            <section className="bg-white py-10 text-center">
                <h2 className="text-2xl sm:text-3xl font-bold text-yellow-600 mb-4">
                    It takes time to build something that lasts
                </h2>
                <p className="text-base sm:text-lg text-gray-700 mb-6">
                    We believe in long-term commitment, continuous improvement, and putting our users first.
                </p>
                <Link
                    to="/about"
                    className="inline-block bg-yellow-600 text-white rounded-full px-6 py-3 font-bold text-lg hover:bg-yellow-700 transition"
                >
                    Read Our Story
                </Link>
            </section>
            ...
            <section className="bg-yellow-200 py-10 text-center">
                <h2 className="text-2xl sm:text-3xl font-bold text-blue-900 mb-4">
                    All-in-one suite for your business
                </h2>
                <p className="text-base sm:text-lg text-gray-700 mb-6">
                    Break down silos, increase efficiency, and empower your team with Practical Manager.
                </p>
                <Link
                    to="/registration"
                    className="inline-block bg-red-600 text-white rounded-full px-6 py-3 font-bold text-lg hover:bg-red-700 transition"
                >
                    Try Now
                </Link>
            </section>
            ...
            <section id="testimonials" className="bg-white py-10 text-center">
                ...
                <div className="flex flex-wrap justify-center gap-6">
                    {testimonials.map((t, i) => (
                        <blockquote
                            key={i}
                            className="bg-blue-50 rounded-xl p-6 max-w-xs w-full font-serif italic text-gray-700 shadow mb-4"
                        >
                            “{t.quote}”<div className="font-bold text-blue-700 mt-2 text-base">{t.author}</div>
                        </blockquote>
                    ))}
                </div>
            </section>
            ...
            <section id="values" className="bg-white py-10 text-center">
                ...
                <div className="flex flex-wrap justify-center gap-6">
                    {values.map((v, i) => (
                        <div
                            key={i}
                            className="bg-gray-50 rounded-2xl shadow-lg p-6 max-w-xs w-full text-center transition hover:scale-105"
                        >
                ...
                <Link
                    to="/about"
                    className="inline-block bg-yellow-600 text-white rounded-full px-6 py-3 font-bold text-lg hover:bg-yellow-700 transition mt-6"
                >
                    Read Our Story
                </Link>
            </section>
                ...
                <div className="bg-white rounded-2xl shadow-lg p-6 w-full max-w-md mx-auto flex flex-col items-center">
                    ...
                    <form className="w-full flex flex-col items-center">
                        <input
                            ...
                            className="w-full p-3 mb-4 rounded-lg border border-gray-300 text-base"
                        />
                        <input
                            type="text"
                        ...
                        <div className="w-full text-left mb-4">
                            <label className="text-sm">
                                <input type="checkbox" required className="mr-2" /> I agree with{" "}
                        ...
                        <div className="flex w-full gap-2">
                            <button
                                type="submit"
                                className="w-1/2 rounded-lg bg-blue-700 text-white font-bold py-3 text-lg transition hover:bg-blue-800"
                            >
                                Submit
                            </button>
                            <button
                                type="reset"
                                className="w-1/2 rounded-lg bg-yellow-600 text-white font-bold py-3 text-lg transition hover:bg-yellow-700"
                            >
                                Reset
                            </button>
                        </div>
            ...
            <footer className="bg-white py-8 text-center text-gray-700 mt-8 shadow border-t border-gray-200">
                ...
                <div className="mb-2 text-gray-500">
                    <a href="#" className="text-blue-700 mr-2 hover:underline">
                        Privacy policy
                    </a>{" "}
                    |{" "}
                    <a href="#" className="text-blue-700 ml-2 hover:underline">
                        Terms of service
                    </a>
                </div>
