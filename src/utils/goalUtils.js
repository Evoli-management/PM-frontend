...
export const calculateTimeInfo = (goal) => {
  ...
  const timeProgressPercent = totalDuration && daysPassed !== null ? Math.min(100, Math.round((daysPassed / totalDuration) * 100)) : null;
...
export const calculateGoalStats = (goals) => {
  ...
  stats.avgTimeProgress = stats.timeProgressCount > 0 ? Math.round(stats.totalTimeProgress / stats.timeProgressCount) : 0;
